                    ...
                    @foreach([0,1,4,2,3] as $index)
                        <li class="gallery-item">
                            <div class="upload-container">
                                ...
                                <input type="hidden" class="image-url" name="image_url{{ $index+1 }}"
                                       value="{{ $gallery[$index]->image_url ?? '' }}">
                                <span class="upload-text">Нажмите или перенесите изображение</span>
                                <img class="image-preview"
                                     src="{{ isset($gallery[$index]) ? asset($gallery[$index]->image_url) : '' }}"
            ...
            area.addEventListener('drop', (e) => {
                ...
                if (e.dataTransfer.files.length > 0) {
                    ...
                    if (imageUrl) {
                        ...
                        console.log(imageUrls[index].value);
